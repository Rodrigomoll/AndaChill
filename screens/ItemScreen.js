        ...
        <ScrollView className="flex-1 px-4 py-6 ">
                ...
                <Image 
                    source={
                        {uri :
                           ...
                           ? data?.photo?.images?.large?.url 
                           : "https://cdn.pixabay.com/photo/2022/11/22/05/34/rose-7608780_1280.jpg"
                        }}
                ...
                <View className="absolute flex-row inset-x-0 top-5 justify-between px-6">
                    <TouchableOpacity
                     ...
                     className="w-10 h-10 rounded-md items-center justify-center bg-white">
                        <FontAwesome5 name="chevron-left" size={24} color="#f95959" />
                    </TouchableOpacity>

                    <TouchableOpacity className="w-10 h-10 rounded-md items-center justify-center bg-[#f95959]">
            ...
            <View className="mt-4 flex-row items-center justify-between">
              ...
              {data?.price_level && (
                ...
                <View className="mt-4 px-4 py-4 rounded-lg bg-[#f95959] items-center justify-center mb-12">
